...
class FeatureExtractor:
    ...
    def get_parser(self):
        ...
        parser.add_argument(
            "--output_folder", type=str, default="input/bdd100k/images/100k/feature_output", help="Output folder"
        )
        parser.add_argument(
            "--feature_name",
            type=str,
    ...
    def _image_transform(self, im):
        ...
        im_width = im_shape[1]
        im_size_min = np.min(im_shape[0:2]) #which of height or width is larger 
    ...
    def get_detectron_features(self, videoframes):
        ...
        current_img_list = current_img_list.to(torch.float32)
    ...
    def extract_features(self, videolist, imgid):
        #self.parts[set]
        ...
        #for idx in range(len(self.data)):
            ...
            features, infos = self.get_detectron_features(videolist[0])
            ...
            for i in range(len(features)):
                features_new = {}
                features_new['img_id'] = imgid+"_frame_"+str(i)
